...
| `table_name`                |   "VEGBILDER" |   `str`   | The table name to check for "non nullable" value fields in the database table definition. If this value is `None`, a nullable check is not run on the json-file                          |                                                                                                                                                                                                                                                                                                |                                                                                                           |
| `table_primary_key`         |   "bildeid"   |   `str`   | The exif tag used as the primary key in the databse. If None, a special handling of primary keys will not be done.                            |                                                                                                                                                                                                                                                                                                |                                                                                                           |
